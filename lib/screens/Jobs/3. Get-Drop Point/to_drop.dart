...
class Job_ToDrop extends StatefulWidget {
  Job_ToDrop() : super();
  @override
  _Job_ToDropState createState() => _Job_ToDropState();
}

class _Job_ToDropState extends State<Job_ToDrop> {
      ...
      builder: (context, state) {
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              'จุดส่ง '+state.job_info.docNumber,
              style: TextStyle(
                color: Colors.white,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              state.job_info.checkInLocation_Info[1]
                                      .checkinCategory +
                                  ":",
                              style: TextStyle(
                            ...
                            Text(
                              state.job_info.checkInLocation_Info[1].point,
                              style: TextStyle(
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 5),
                                Text(
                                  state.job_info.checkInLocation_Info[1].date,
                                  style: TextStyle(
                                    color: Palette.thisBlue,
                                    fontSize: 18,
                                    fontWeight: FontWeight.bold,
