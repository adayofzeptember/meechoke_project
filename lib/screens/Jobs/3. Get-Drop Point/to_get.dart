      ...
      builder: (context, state) {
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text(
       'จุดรับ '+state.job_info.docNumber,
              style: TextStyle(
                color: Colors.white,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              state.job_info.checkInLocation_Info[0]
                                      .checkinCategory +
                                  ":",
                              style: TextStyle(
                            ...
                            Text(
                              state.job_info.checkInLocation_Info[0].point,
                              style: TextStyle(
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 5),
                                Text(
                                  state.job_info.checkInLocation_Info[0].date,
                                  style: TextStyle(
                                    color: Palette.thisBlue,
                                    fontSize: 18,
                                    fontWeight: FontWeight.bold,
